...
if selected == "Teoría":
  ...
  st.markdown("""
    ...
    ▶Finalmente, cabe aclarar que si bien, podemos obtener predicción a partir del fit de la segunda y la tercera gráfica, puede que estas no sean muy congruentes con el comportamiento de la pandemia. Esto puede deberse a que, como se puede ver en la última gráfica, la pandemia tuvo un comportamiento cíclico, teniendo picos de casos confirmados cada cierto tiempo. Es por eso que una binomial no puede mostrar eso, por lo tanto, para hacer mejores predicciones se necesitaría un tipo de ajuste diferente. 
